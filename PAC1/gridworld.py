...
GRIDS = {
    ...
    "Ex6-5x5": [
        [BAD_SMALL, BAD_SMALL, BAD_SMALL, BAD_SMALL, BAD_SMALL],
        [BAD_SMALL, WALL, WALL, WALL, BAD_SMALL],
        [BAD_SMALL, WALL, GOOD, BAD_SMALL, BAD_SMALL],
        [BAD_SMALL, BAD, BAD, BAD_SMALL, BAD_SMALL],
        [BAD_SMALL, BAD_SMALL, BAD_SMALL, BAD_SMALL, BAD_SMALL],
    ]
}
# fmt: on
...
class Gridworld5x5_Ex6(Gridworld):
    def _reset(self, seed: int = None, **kwargs):
        Gridworld._reset(self, seed=seed, **kwargs)
        self.agent_pos = (2, 0)
        return self.get_state(), {}
